...
const TechStack = () => {
  const [activeIndex, setActiveIndex] = useState(3); // Default to Java
    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex flex-col items-center">
        ...
        >
          ...
          <div className="w-24 h-1 bg-white/50 rounded-full mt-4" />
        </motion.div>
            ...
            <div key={tech.name} className="flex flex-col items-center group">
              <div
                className="w-12 h-12 md:w-16 md:h-16 flex items-center justify-center 
                                   grayscale opacity-20 blur-sm transform-gpu"
              >
                {tech.icon}
              </div>
            </div>
